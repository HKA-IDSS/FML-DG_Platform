...
#     AdultDataset, CovertypeDataset, HeartDataset, HeartDatasetBinary, NewAdultDataset
...
from experiment_parameters.strategies.server.FedAvgEmbedding import FedAvgEmbedding
