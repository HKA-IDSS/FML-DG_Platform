...
If you are working with the main branch of the backend, then the 'ReactKeycloakProvider' and the privateRoute checks need to be removed.

<details><summary>Replace App.js with this:</summary>
...
// Helmet sets the background colour for all components
function App() {
    return (
        <div
            className='App'
        ...
        >
            ...
            <Header style={{color: 'white', textAlign: 'center'}}>
                <div>
                    <h1 style={{color: 'white'}}>Federated Machine Learning Dashboard</h1>
                </div>
            </Header>
            <Sidebar pageWrapId={'page-wrap'} outerContainerId={'outer-container'}/>
            <BrowserRouter>
                <Routes>
                    <Route path='/datasets' exact element={<DatasetsFunctional/>}/>
                    <Route path='/favorites' exact element={<Favorites/>}/>
                    <Route path='/groups' exact element={<GroupsFunctional/>}/>
                    <Route path='/' exact element={<Home/>}/>
                    <Route path='/mlmodels' exact element={<MLModelsFunctional/>}/>
                    <Route path='/recently' exact element={<Recently/>}/>
                    <Route path='/strategies' exact element={<StrategiesFunctional/>}/>
                    <Route path='/user' exact element={<UserFunctional/>}/>
                    {/* <Route path="/datasets" exact element={<PrivateRoute> <DatasetsFunctional/> </PrivateRoute>}/>
                        <Route path="/favorites" exact element={<PrivateRoute> <Favorites/> </PrivateRoute>}/>
                        <Route path="/groups" exact element={<PrivateRoute> <GroupsFunctional/> </PrivateRoute>}/>
                        <Route path="/" exact element={<PrivateRoute> <Home/> </PrivateRoute>}/>
                        <Route path="/mlmodels" exact element={<PrivateRoute><MLModelsFunctional/> </PrivateRoute>}/>
                        <Route path="/recently" exact element={<PrivateRoute> <Recently/> </PrivateRoute>}/>
                        <Route path="/strategies" exact element={<PrivateRoute><StrategiesFunctional/></PrivateRoute>}/>
                        <Route path="/user" exact element={<PrivateRoute><UserFunctional/></PrivateRoute>}/> */}
                </Routes>
            </BrowserRouter>
