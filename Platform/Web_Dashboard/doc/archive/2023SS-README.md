...
<div align="center">
    ...
    <p align="center">
        <h3>Summerterm 2023</h3>
        <br />
        Developed by Katharina Machilek and Tim Smolne
        <br />
...
The implementations that were being made during the summer term 2023 build on an already existing project. The old 
readme file and documentation can be found here: [old readme.md](AlexanderREADME.md), [other old readme.md](README.katharina.md), [old devdocument](src/doc/devdocument.md) and [other old devdocument](src/doc/dev-document.md)

Please have a look at the developer document [dev-document](src/doc/dev-document-3.md) located inside the doc folder to 
...
For the project to work properly please also set up the Api (https://iz-gitlab-01.hs-karlsruhe.de/klfa1015/data-governance-api-rest).
For the setup please follow the instructions in the README.md files of the corresponding repository.
If you are working with the main branch of the backend, please comment out the private routes and the ReactKeycloakProvider in the App.js.
After setting everything up you should be able to create and delete new strategies, datasets, ml-models and groups. 
If you are working with the keycloak branch of the backend you can leave the App.js file as is.
In this branch, the dashboard is being managed with the help of Keycloak, so that the user is required to log in and so 
