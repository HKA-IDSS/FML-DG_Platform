...
from .Aggregate import aggregate_nn
...
# from flower.Util import save_data_on_pickle, from_string_to_dict, get_test_data
...
class FedAvgRewritten(FedAvg):
    ...
    def aggregate_evaluate(
        ...
        normalized_metrics = []
        log(INFO, f"Eval metric: {eval_metrics}")
        for client, dictionary_of_metrics in eval_metrics.items():
            ...
            log(INFO, f"Dictionary metric: {dictionary_of_metrics}")
            # log(INFO, f"Dictionary metric: {dictionary_of_metrics}")
