...
#                 dict_parameters[f'n_units_l{layer}'] = trial.suggest_int(f'n_units_l{layer}', 16, 128)
#                 dict_parameters[f'dropout_l{layer}'] = trial.suggest_float(f'dropout_l{layer}', 0.1, 0.4, step=0.1)
