...
class CrossEntropyLoss(Metric):
    ...
    def __sub__(self, other):
        return CrossEntropyLoss(other.get_value() - self.get_value())
...
# def min_out_two_metrics(first_dict, second_dict, metric):
#     metrics_first_dict = first_dict.get_value()
#     metrics_second_dict = second_dict.get_value()
#     metric_to_return = metrics_first_dict[metric].min_out_two(metrics_second_dict[metric])
#     return metric_to_return
#
#
# def max_out_two_metrics(first_dict, second_dict, metric):
#     metrics_first_dict = first_dict.get_value()
#     metrics_second_dict = second_dict.get_value()
#     metric_to_return = metrics_first_dict[metric].max_out_two(metrics_second_dict[metric])
#     return metric_to_return
#
#
# def scaling_values(first_dict, second_dict):
#     aux_dict = {}
#     metrics_first_dict = first_dict.get_value()
#     metrics_second_dict = second_dict.get_value()
#     for key in first_dict.get_value().keys():
#         aux_dict[key] = metrics_first_dict[key].max_out_two(metrics_second_dict[key])
#
#     return DictOfMetrics(aux_dict)
